...
if(using_googlesheets){
  ...
  position_data <- read_sheet(positions_sheet_loc,
                              sheet = "entries", skip = 1)
  skills <- read_sheet(positions_sheet_loc,
                              sheet = "language_skills", skip = 1)
  text_blocks <- read_sheet(positions_sheet_loc,
                              sheet = "text_blocks", skip = 1)
  contact_info <- read_sheet(positions_sheet_loc,
                              sheet = "contact_info", skip = 1)
